...
public class SpecValidationSchema {
    ...
    public static final GraphQLObjectType dog = GraphQLObjectType.newObject()
                                                                 ...
                                                                 .field(newFieldDefinition().name("name").type(
                                                                         nonNull(Scalars.GraphQLString)))
                                                                 .field(newFieldDefinition().name("nickname").type(
                                                                         Scalars.GraphQLString))
                                                                 .field(newFieldDefinition().name("barkVolume").type(
                                                                         Scalars.GraphQLInt))
                                                                 .field(newFieldDefinition().name(
                                                                         "doesKnowCommand").type(
                                                                         nonNull(Scalars.GraphQLBoolean))
                                                                                            .argument(singletonList(
                                                                                                    dogCommandArg)))
                                                                 .field(newFieldDefinition().name(
                                                                         "isHousetrained").type(Scalars.GraphQLBoolean)
                                                                                            .argument(singletonList(
                                                                                                    atOtherHomesArg)))
    ...
    public static final GraphQLObjectType cat = GraphQLObjectType.newObject()
                                                                 ...
                                                                 .field(newFieldDefinition().name("nickname").type(
                                                                         Scalars.GraphQLString))
                                                                 .field(newFieldDefinition().name("meowVolume").type(
                                                                         Scalars.GraphQLInt))
                                                                 .field(newFieldDefinition().name(
                                                                         "doesKnowCommand").type(
                                                                         nonNull(Scalars.GraphQLBoolean))
    ...
    public static final GraphQLObjectType queryRoot = GraphQLObjectType.newObject()
                                                                       .name("QueryRoot")
                                                                       .field(newFieldDefinition().name("dog").type(
                                                                               dog))
                                                                       .field(newFieldDefinition().name("pet").type(
                                                                               pet))
                                                                       .build();
